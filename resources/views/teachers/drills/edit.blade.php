...
@section('content')
        ...
        <form id="form-drill-create" action="{{ route('modules.lessons.drills.update', [
            ...
            <section>
                <div class="row">
                    <div class="col-xl-12 col-sm-12 input-group mb-3">
                        ...
                        <div class="col-sm-8">
                            <input required type="text" id="name" name="name" class="form-control"  placeholder="" value="{{ $drill->name }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-sm-12 input-group mb-3">
                        ...
                        <div class="col-sm-8">
                            <textarea id="" cols="30" rows="10" class="form-control" name="instructions">{{ $drill->instructions }}</textarea>
                        </div>
                    </div>
                </div>
